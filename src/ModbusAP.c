...
int read_h_regs( char *server_add, __uint16_t start_addr, __uint16_t n_reg, __uint16_t *val )
{
    ...
    //Build APDU Header
    APDU[0] = (__uint8_t) 0x03; //Function Code - 3
    ...
    //APDU[5] = (__uint8_t)  2 *n_r; // Byte Count
